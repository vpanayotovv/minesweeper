...
import com.project.minesweeper.exception.NotFoundException;
import com.project.minesweeper.model.Difficulty;
import com.project.minesweeper.model.Game;
import com.project.minesweeper.service.GameRepository;
...
public class GameControllerTest {
    ...
    public void newGameRedirectsUserToTheCreatedGame() {
        RedirectView response = controller.startNewGame(Difficulty.INTERMEDIATE);
